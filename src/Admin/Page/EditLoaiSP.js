...
const EditLoaiSP = () =>{
    ...
    const createLoaiSanPham = async (e) => {
        ...
        try {
            await axios.post('http://localhost:5000/updateLoaiSanPham', formData, {
                headers: {
            ...
            alert('Có lỗi xảy ra khi sửa loại sản phẩm.');
        }
    };

    return (
        <div className='w-1/2 mx-auto p-4'>
            <h2 className='text-center text-xl'>Edit Categories</h2>
                ...
                <form key={index} className='border p-8' onSubmit={createLoaiSanPham}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => handleCategoryNameChange(e, item.category_id)}
                        />
                    </div>
                    <div>
